...
public class StorageTest {
	...
	/*private Task task0 = new Task("do homework", "10am", PRIORITY_LEVEL.HIGH, TASK_NATURE.EVENT, TASK_STATUS.UPCOMING);
	private Task task1 = new Task("play soccer", "5pm",  PRIORITY_LEVEL.LOW, TASK_NATURE.EVENT, TASK_STATUS.UPCOMING);
	private Task task2 = new Task("eat dinner", "7pm",  PRIORITY_LEVEL.MEDIUM, TASK_NATURE.EVENT, TASK_STATUS.UPCOMING);
